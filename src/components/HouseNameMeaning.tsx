...
const HouseNameMeaning = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-5 sm:py-16 md:py-28 px-3 sm:px-6 relative overflow-hidden"
      style={{
    ...
    >
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-4 sm:mb-12 md:mb-16">
          <h2
            className="text-display text-lg sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-3"
            style={{
              color: "hsl(345, 70%, 28%)",
              opacity: visible ? 1 : 0,
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-3 sm:gap-8 lg:gap-12">
          ...
          >
            <h3 className="text-display text-sm sm:text-xl md:text-2xl mb-3 sm:mb-6 text-foreground text-center border-b border-[hsla(43,85%,52%,0.3)] pb-2 sm:pb-4">
              The Divine Meaning
            </h3>
            ...
            <div className="mt-3 sm:mt-8 pt-3 sm:pt-6 border-t border-[hsla(43,85%,52%,0.3)] text-center">
              <p className="text-body-serif text-xs sm:text-lg md:text-xl italic text-foreground gold-text">

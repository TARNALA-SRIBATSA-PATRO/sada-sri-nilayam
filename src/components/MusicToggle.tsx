...
const MusicToggle = () => {
  ...
  useEffect(() => {
    // Use a free devotional audio URL placeholder - users can replace
  ...
  return (
    ...
    >
      {playing ? (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="hsl(43, 85%, 52%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
